...
class ScheduleFragment : BaseFragment<FragmentScheduleBinding, ScheduleViewModel>(ScheduleViewModel::class) {
    ...
    override fun initViews() {
        ...
        binding.mondayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.orange
        ))
    ...
    inner class ScheduleAdapter : RecyclerView.Adapter<ScheduleAdapter.ScheduleViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ScheduleViewHolder, position: Int) {
            if (position < viewModel.planSchedules.size && position >= 0) {
    ...
    private fun resetWeekDayPicker() {
        binding.mondayPicker.background = ContextCompat.getDrawable(requireContext(),
            R.drawable.shape_circle_transparent
        )
        binding.mondayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.grey_background
        ))
        binding.tuesdayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.grey_background
        ))
        binding.wednesdayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.grey_background
        ))
        binding.thursdayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.grey_background
        ))
        binding.fridayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.grey_background
        ))
        binding.saturdayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.grey_background
        ))
        binding.sundayPicker.setBackgroundColor(ContextCompat.getColor(requireContext(),
            R.color.grey_background
        ))
    }
}